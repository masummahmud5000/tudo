...
export default function Home() {
  return(
    <main className="px-10 py-30 h-screen flex flex-col items-center gap-35">
      ...
      <Link className="bg-green-600 px-10 py-3 text-2xl text-white font-bold rounded-2xl animate-bounce border-2 border-amber-400" href='/singUp'>Account Open Now</Link>
    </main>
  );
}

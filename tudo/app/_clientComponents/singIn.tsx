        ...
        <main>
            <form className="singup flex flex-col py-10">
                ...
                <div className="flex gap-2 items-center mt-4 text-xl border-b-2 border-amber-600">
                    ...
                    <input className="w-80" type="password" required placeholder="Enter Your Password"/>
                </div>
                <span className="mt-5 text-red-700">No Account <Link className="cursor-pointer font-bold" href="/singUp">Create Account</Link></span>
